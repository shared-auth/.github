...
- [Provider resource naming and identity regression matrix](docs/PROVIDER-RESOURCE-NAMING-TEST-MATRIX.md) defines positive and negative coverage for aliases, immutable provider refs, ambiguity, realm/plane isolation, strict admin verification, revocation monotonicity, and child authorization boundaries.
