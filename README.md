...
- Async state-machine, concurrency, and formal-verification design: [`docs/ASYNC-AUTH-STATE-MACHINES-AND-FORMAL-VERIFICATION.md`](docs/ASYNC-AUTH-STATE-MACHINES-AND-FORMAL-VERIFICATION.md)
